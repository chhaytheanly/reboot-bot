...
def main():
    """Initialize and run the Telegram bot with improved UX"""
    ...
    # ========== Text Message Handlers (for menu buttons) ==========
    # Tenant menu button handlers
    ...
    logger.info("Bot started with improved UX!")
    app.run_polling()
